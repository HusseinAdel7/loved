...
const notesEN = [
  "\"Counting down the hours to wrap you in my arms...\"",
  "\"Can't wait to whisper Happy Birthday in your ear, my queen...\"",
  "\"Every tick of the clock is a countdown to our next memory...\"",
  "\"The stars are alignment, waiting to celebrate your beautiful light...\"",
  "\"To the day the universe gave me the absolute anchor of my soul...\"",
  "\"My heart beats in perfect sync with the ticking of this clock...\""
];

const notesAR = [
  "\"أعد الساعات والدقائق لأحتضنكِ بين ذراعيّ الدافئتين...\"",
  "\"لا يمكنني الانتظار لأهمس بـ 'عيد ميلاد سعيد' في أذنيكِ يا ملكتي...\"",
  "\"كل دقة من دقات هذه الساعة هي عد تنازلي لذكرانا القادمة...\"",
  "\"النجوم تصطف في الفلك، مترقبة الاحتفال بنوركِ الجميل...\"",
  "\"إلى اليوم الذي أهداني فيه الكون المرساة الحقيقية لروحي وقلبي...\"",
  "\"ينبض قلبي بتناغم تام مع دقات عقارب هذه الساعة...\""
];
